(()=>{
  ...
  .tdp-thread-horizontal,.tdp-thread-vertical{position:absolute;display:block;border-radius:999px;background:repeating-linear-gradient(90deg,#c9828d 0 7px,#f5d3cf 7px 11px,#9e5865 11px 17px);box-shadow:0 2px 3px rgba(75,38,39,.22),inset 0 1px 0 rgba(255,255,255,.38);transition:transform .72s cubic-bezier(.18,.84,.22,1),opacity .4s ease}
  .tdp-thread-horizontal{left:5%;right:5%;top:54%;height:7px;transform:rotate(-1.2deg)}
  .tdp-thread-vertical{top:5%;bottom:5%;left:50%;width:7px;transform:translateX(-50%) rotate(.8deg);background:repeating-linear-gradient(180deg,#c9828d 0 7px,#f5d3cf 7px 11px,#9e5865 11px 17px)}
  .tdp-thread-bow{position:absolute;left:50%;top:54%;width:62px;height:40px;transform:translate(-50%,-50%);filter:drop-shadow(0 4px 4px rgba(75,38,39,.19));transition:transform .6s ease,opacity .35s ease}
  .tdp-thread-bow:before,.tdp-thread-bow:after{content:"";position:absolute;top:6px;width:30px;height:22px;border:6px solid #b96f7b;border-radius:65% 42% 64% 38%;background:rgba(255,235,230,.15)}
  .tdp-thread-bow:before{right:50%;transform:rotate(13deg)}.tdp-thread-bow:after{left:50%;transform:scaleX(-1) rotate(13deg)}
  .tdp-thread-heart{position:absolute;left:50%;top:54%;width:25px;height:25px;transform:translate(-50%,-50%) rotate(-45deg);border-radius:5px 50% 6px 50%;background:radial-gradient(circle at 34% 28%,#f4c5c9 0 10%,#c2737f 28%,#96505e 72%,#6f3340 100%);box-shadow:0 5px 9px rgba(77,35,41,.27),inset 0 1px 2px rgba(255,255,255,.4);transition:transform .55s ease,opacity .35s ease}
